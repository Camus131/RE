...
namespace OGE
{
    ...
    public:
        ...
        Vec4d() { v_[0] = 0.0; v_[1] = 0.0; v_[2] = 0.0; v_[3] = 0.0; }
        Vec4d(value_type x, value_type y, value_type z, value_type w) { v_[0] = x; v_[1] = y; v_[2] = z; v_[3] = w; }
        Vec4d(const Vec4d& v) { v_[0] = v.v_[0]; v_[1] = v.v_[1]; v_[2] = v.v_[2]; v_[3] = v.v_[3]; }
        Vec4d(const Vec4f& v) { v_[0] = v[0]; v_[1] = v[1]; v_[2] = v[2]; v_[3] = v[3]; }
        Vec4d(const Vec3d& v, value_type w) { v_[0] = v[0]; v_[1] = v[1]; v_[2] = v[2]; v_[3] = w; }
        Vec4d(const Vec3f& v, value_type w) { v_[0] = v[0]; v_[1] = v[1]; v_[2] = v[2]; v_[3] = w; }

        //重置内容
        Vec4d& Set(value_type x, value_type y, value_type z, value_type w)
        {
            v_[0] = x;
            v_[1] = y;
            v_[2] = z;
        ...
        Vec4d& Set(const Vec3d& v, value_type w)
        {
            v_[0] = v[0];
            v_[1] = v[1];
            v_[2] = v[2];
        ...
        Vec4d& Set(const Vec3f& v, value_type w)
        {
            v_[0] = v[0];
            v_[1] = v[1];
            v_[2] = v[2];
        ...
        //点乘
        value_type operator * (const Vec4d& v) const { return v_[0] * v.v_[0] + v_[1] * v.v_[1] + v_[2] * v.v_[2] + v_[3] * v.v_[3]; }
        ...
        bool operator != (const Vec4d& v) const { return v_[0] != v.v_[0] || v_[1] != v.v_[1] || v_[2] != v.v_[2] || v_[3] != v.v_[3]; }

        Vec4d operator + (const Vec4d& v) const { return Vec4d(v_[0] + v.v_[0], v_[1] + v.v_[1], v_[2] + v.v_[2], v_[3] + v.v_[3]); }
